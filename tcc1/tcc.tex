...
Os principais desafios para a gestão de estoque são as variações sazonais, as emergências sanitárias e as mudanças no perfil epidemiológico da população, com impactos significativos em como será realizado a previsão de demanda na cadeia de abasteciemnto hospitalar. A falta de material pode afetar diretamente a saúde do paciente, ao passo que o excesso pode causar desperdícios, dado que muitos materiais têm um prazo de validade limitado. O uso de diversos sistemas e metodologias de estoque, irão auxiliar no processo de previsão e abasteciemto de forma eficiente a manter em ordem os procedimentos diarios sem transtornos para as instituições \citeonline{Hiaretto2021}.

Uma abordagem promissora reside na aplicação de técnicas de Deep Learning (DL), que têm demonstrado potencial para otimizar os processos de gestão da cadeia de abastecimento. Alguns estudos têm explorado a utilização de algoritmos de Machine Learning (ML) para resolver problemas de previsão de demanda, apresentando assim alternativas para melhorar a eficiência e a rentabilidade das cadeias de produção farmacêutica e hopitalar \citeonline{Andres2025}. No entanto, a aplicação de redes neurais recorrentes (RNN) para previsão de demanda em estoques hospitalares ainda é um campo pouco explorado, especialmente no que diz respeito à análise de sensibilidade do modelo a variações nos parâmetros de entrada.
...
As RNN têm vasta capacidade para lidar com séries temporais, aprendendo dependências temporais e melhorando a precisão das previsões. No entanto, no contexto hospitalar, a sua utilização com este objetivo não está muito difundida, principalmente na análise de sensibilidade aos parâmetros.
...
Este trabalho justifica-se pela necessidade de aprimoramento de técnicas e ferramentas de previsão de demanda, assim como de gerenciamento de estoques hospitalares. Tendo em conta a complexidade de uma variabilidade na natureza temporal dos dados, uma abordagem mais robusta e adaptativa, com uso de aprendizado de máquina, pode auxiliar.

No ponto de vista académico, este estudo contribui para o avanço e análise de técnicas de aprendizado de máquina, com foco em redes neurais recorrentes (RNNs), voltado para a área da saúde. Sendo uma área vastamente explorada, ainda existe espaço para estudo e avanço no que se diz respeito a fazer uso dessas técnicas para o âmbito hospitalar.

Sob o ponto de vista profissional, a otimização na previsão da demanda de itens críticos tem efeito significativo para a área de saúde. Podendo auxiliar no gerenciamento de excesso de insumos, gerando uma diminuição de impactos financeiros, e na falta desses insumos, que pode acarretar em má eficiência no atendimento ao paciente, podendo gerar complicações mais severas. Apoiando gestores voltados ao de planejamento a tomarem as melhores definições com ganho de eficiência.

Muitos sistemas ainda utilizam técnicas tradicionais de previsão, as quais não conseguem reconhecer padrões temporais no consumo hospitalar, podendo ser uma lacuna. O uso de RNNs para melhoria nesse fluxo, com ênfase no estudo de sensibilidade às variabilidades dos dados, tais dados sendo de fontes públicas, pode contribuir para o preenchimento desta lacuna existente.
% ---------------------------------------------------------------
\section{Objetivo}
\label{sec:objetivo}
...
Anlisar sensibilidade de um RNN para previsão de estoque hospitalar crítico
...
\begin{enumerate}
    ...
    \item Implementar algoritimo com tecnicas de RNN;
\end{enumerate}
...
redes de unidades semelhantes a neurônios. O procedimento ajusta repetidamente os pesos das conexões na rede de modo a minimizar uma medida da diferença entre o vetor de saída real da rede e o vetor de saída desejado.".
