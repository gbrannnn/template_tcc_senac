...
A crescente complexidade na gestão de estoques hospitalares, em conjunto à natureza temporal e variável da demanda por insumos críticos, evidencia a necessidade de abordagens mais robustas para previsão de demanda. Métodos tradicionais, como médias históricas e modelos estatísticos simples, frequentemente não conseguem capturar os padrões dinâmicos presentes nesse tipo de dado, o que justifica a investigação e analise de técnicas de aprendizado de máquina capazes de lidar com essa variabilidade. Nesse sentido, este trabalho propõe a aplicação de uma RNN com arquitetura LSTM, com ênfase na análise de sensibilidade do modelo aos parâmetros de entrada, como forma de ampliar a compreensão sobre o comportamento desses modelos em contextos hospitalares.

Do ponto de vista acadêmico, embora as RNNs e a arquitetura LSTM sejam amplamente estudadas para tarefas de previsão em séries temporais, sua aplicação específica no gerenciamento de estoques hospitalares ainda possui vasta exploração. Mais escassa ainda é a investigação sobre como variações nos parâmetros de entrada afetam o desempenho preditivo nesses cenários. Assim, este estudo contribui para preencher essa lacuna, oferecendo uma análise sistemática do comportamento do modelo frente à variabilidade dos dados.

Do ponto de vista profissional, a imprecisão na previsão de demanda de itens críticos gera consequências diretas para a operação hospitalar. O excesso de insumos representa desperdício financeiro e risco de vencimento de materiais, enquanto a falta pode comprometer procedimentos e colocar em risco a segurança do paciente. Uma ferramenta preditiva mais precisa oferece aos gestores de saúde uma base mais sólida para a tomada de decisões, contribuindo tanto para a eficiência operacional quanto para a qualidade do atendimento.
...
Este estudo tem como objetivo avaliar o uso de um RNN para previsões de estoque hospitalar, analisar sensibilidade em seus parâmetros de entrada e como isso afeta os resultados. 
...
Analisar sensibilidade de um RNN para previsão de estoque hospitalar crítico
...
\begin{enumerate}
    ...
    \item Coletar base de dados públicas para treinamento;
    \item Identificar e analisar onde será realizado os treinamentos;
    \item Implementar algoritmo com tecnicas de RNN;
\end{enumerate}
